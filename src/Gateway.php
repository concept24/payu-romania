<?php
namespace Concept24\Omnipay\PayURomania;

use Omnipay\Common\AbstractGateway;
use Concept24\Omnipay\PayURomania\Message\PurchaseResponse;
...
class Gateway extends AbstractGateway
{
    ...
    public function getDefaultParameters()
    {
        return array(
            ...
            'secretKey' => env('PAYU_MERCHANT_SECRET',''),
            'testMode' => env('PAYU_TEST_MODE',true),
        );
    }
    ...
    public function authorize(array $parameters = array()){
        return $this->createRequest('\Concept24\Omnipay\PayURomania\Message\AuthorizeRequest', $parameters);
    }
    ...
    public function capture(array $parameters = array()){
        return $this->createRequest('\Concept24\Omnipay\PayURomania\Message\CaptureRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Concept24\Omnipay\PayURomania\Message\PurchaseRequest', $parameters);
    }
    ...
    public function refund(array $parameters = array()){
        return $this->createRequest('\Concept24\Omnipay\PayURomania\Message\RefundRequest', $parameters);
    }
